...
Now you should install the RepairVision Tool from the Eclipse Downloader wizard which includes update websites of various tools and frameworks. To do so, click on Help and select Install New Software from the Options Menu. See figure below <a href="#fig:{{ fig_step1.2 }}">Figure {{ fig_step1.2 }} target="_blank" </a>
...
tep1:
After finishing the installation of the Revision Tool, you're supposed to restart the Eclipse IDE to apply the changes and adding the Tool to the IDE... See figure below <a href="#fig:{{ fig_step1.4 }}">Figure {{ fig_step1.4 }} target="_blank" </a>
...
In this step, you should add the Repository. To do so, click open perspective from "Window" menu and select "SVN Repository Exploring", then click on "Open" Button. As shown if figure below <a href="#fig:{{ fig_step2.1 }}">Figure {{ fig_step2.1 }} target="_blank" </a>
...
In this step, you should add the Repository url link in "Github" by clicking on "New Repository Location" from "File" menu. At the end, click on "Finish" button. See figure below  <a href="#fig:{{ fig_step2.2 }}">Figure {{ fig_step2.2 }} target="_blank" </a>
...
Here, the representations of the UML Example's Class Diagram are shown in different window panes in the editor... See figure below <a href="#fig:{{ fig_step3.1 }}">Figure {{ fig_step3.1 }} target="_blank" </a>
...
For having the view of the UML Example's Class Diagram, you should go to "Window" and "Show View", then "Other" and select the Editor to be added in the EClipse IDE just like shown in the figure... <a href="#fig:{{ fig_step3.2 }}">Figure {{ fig_step3.2 }} target="_blank" </a>
...
Now, It's time to start using the "RepairVision" tool by just adding the "ModelRepair" Plugin in the "Show View" wizard... See figure below <a href="#fig:{{ fig_step3.3 }}">Figure {{ fig_step3.3 }} target="_blank" </a>
...
After inserting the "Model Repair" Plugin, the "Model Repair" window pane with the detailed tool features is appeared in the right side panel of the Eclipse IDE... See figure below <a href="#fig:{{ fig_step3.4 }}">Figure {{ fig_step3.4 }} target="_blank" </a>
...
In this step, you can validate the input UML Example's Class Diagram and observe its status and result (Failure or Success!) in the right panel of the EClipse IDE... See figure below <a href="#fig:{{ fig_step3.5 }}">Figure {{ fig_step3.5 }} target="_blank" </a>
...
Finally, You can Apply the recommended changes for resolving the consistencies and soon after checking the results. As shown in the following figure <a href="#fig:{{ fig_step3.7 }}">Figure {{ fig_step3.7 }} target="_blank" </a>
